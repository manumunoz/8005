...
class Constants(BaseConstants):
    ...
    words = dict()
    words[1] = ['aeonic', 'canoe', 'cocain', 'cocaine', 'conic', 'ocean']
    words[2] = ['baking', 'baning', 'kiang']
    words[3] = ['aedes', 'ashed', 'dates', 'deash', 'death', 'deaths', 'deets', 'eased', 'hades', 'hadst', 'haets', 'haste',
    ...
    words[4] = ['arles', 'asker', 'askew', 'eaks', 'earls', 'eskar', 'kales', 'laker', 'lakers', 'lakes', 'lares', 'larks',
    ...
    words[5] = ['alert', 'alter', 'areic', 'ariel', 'artel', 'atelic', 'caret', 'carle', 'carte', 'cartel', 'cater', 'ceria',
    ...
    words[6] = ['cousins', 'scions', 'chinos', 'sushi', 'sinus', 'shuns', 'scion', 'incus', 'hocus', 'cuish', 'coins', 'chins',
            'cushion','sonics','cousin','uncos','sonic','sinhs','shins','nisus','icons','cusso','conus','cions','chino']
    words[7] = ['coempt', 'comer', 'comet', 'compt', 'compute', 'comte', 'coper', 'copter', 'coupe', 'court', 'couter', 'crept', 'croup', 'croupe',
    ...
    words[8] = ['compel', 'clomp', 'celom']
    words[9] = ['retinal', 'ratline', 'lantern', 'trinal', 'tineal', 'tanner', 'retina', 'retain', 'rental', 'ratlin', 'narine', 'linter', 'linear',
    ...
    words[10] = ['smooth', 'soths', 'sooth', 'shoot', 'moths', 'mosso', 'hosts', 'homos', 'sooths', 'shoots', 'soots', 'shots', 'shoos',
              'mosts','moots','hoots']
    words[11] = ['teiids', 'teiid', 'steed', 'edits', 'diets', 'deets', 'tidies', 'tides', 'stied', 'sited', 'dites', 'deist']
    words[12] = ['ferula', 'earful', 'ureal', 'lucre', 'flare', 'feral', 'farle', 'facer', 'clear', 'alure', 'fulcra', 'fecula',
              'carful','ulcer','lacer','feuar','fecal','farce','cruel','carle']
    words[13] = ['tireder', 'retire', 'reedit', 'trier', 'treed', 'rider', 'erred', 'drier', 'deter', 'retried', 'tiered', 'retied',
              'dieter','tried','tired','retie','eider','direr']
    words[14] = ['savior', 'carious', 'soucar', 'scoria', 'savior', 'curios', 'visor', 'vicar', 'vairs', 'scaur', 'orcas', 'curia',
    ...
    words[15] = ['lucidity', 'fluidic', 'tidily', 'cliffy', 'lytic', 'lucid', 'icily', 'fluty', 'fitly', 'dicty', 'clift', 'difficult',
            'fluidity','dulcify','fitful','citify','ludic','licit','fluyt','fluid','fifty','culti','cliff']
    words[16] = ['vireo', 'obeah', 'haver', 'bravi', 'bohea', 'aiver', 'abhor', 'havior', 'rehab', 'hover', 'bravo', 'brave', 'bevor', 'above']
    words[17] = ['hippo', 'hippos', 'hippy', 'hooly', 'hoops', 'hoppy', 'hypos', 'lippy', 'loops', 'loopy', 'loppy', 'olios', 'plops',
    ...
    words[18] = ['raider', 'arider', 'rimer', 'rider', 'rearm', 'ramie', 'media', 'irade', 'drear', 'direr', 'derma', 'darer', 'armed',
              'airer','aimer','aider','admirer','marred','admire','rimed','redia','rared','mired','madre','drier','dream',
              'dimer','deair','armer','amide','aired','aimed']
    words[19] = ['taker', 'mater', 'armet', 'tamer', 'ramet', 'maker']
    words[20] = ['writes', 'wisent', 'twines', 'twiers', 'triens', 'sinter', 'nitres', 'inters', 'inerts', 'writs', 'wrist', 'wrest',
    ...
    words[21] = ['reseals', 'leasers', 'sealer', 'reseal', 'refels', 'rassle', 'leases', 'lasers', 'fleers', 'feases', 'falser', 'easels',
    ...
    words[22] = ['ennuis', 'suns', 'sinhs', 'shuns', 'shine', 'nisus', 'issue', 'shines', 'sushi', 'sinus', 'sines', 'shins', 'shies', 'nines', 'ennui']
    words[23] = ['wenny', 'renin', 'winner', 'winey', 'rewin', 'inner']
    words[24] = ['suints', 'satins', 'units', 'tunas', 'suits', 'stuns', 'snits', 'sinus', 'satin', 'saint', 'nisus', 'issuant',
